  ...
  useEffect(() => {
    const calculateGap = () => {
      if (containerRef.current) {
        ...
        // justify-center splits remaining space 50/50, so we need half for the bottom
        const totalGap = Math.max(0, viewportHeight - contentHeight);
        const bottomGap = totalGap / 2;
        setGapHeight(bottomGap);
      }
    };
